...
print 12, "test"!= "testing"
print 13, not(True and False)
print 14, not (1==1, 0 !=1)
print 15, not (10 == 1 or 100 == 1000)
print 16, not (1 != 10 or 3 == 4)
print 17, not ("testing" == "testing" and "zed" == "gool guy")
...
print 21, "test" and "test"
print 22, "test" and 1
print 23, False and 1
